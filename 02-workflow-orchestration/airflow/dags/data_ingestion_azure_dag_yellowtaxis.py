...
URL_PREFIX = f"https://github.com/DataTalksClub/nyc-tlc-data/releases/download/yellow/"
...
with DAG(
    dag_id="data_ingestion_azure_dag_yellowtaxis",
    schedule_interval="@monthly",
    default_args=default_args,
    catchup=True,
    max_active_runs=1,
    tags=['dtc-de-all-yellowtaxis'],
) as dag:
